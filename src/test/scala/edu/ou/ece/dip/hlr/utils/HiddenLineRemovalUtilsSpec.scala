...
class HiddenLineRemovalUtilsSpec extends SpecificationBase {
  ...
  "carVertex,10, 0, 20, 0, 10, 0" in {
    val v_1 = new Point3D(18.672503f, -1.031470f, 113.021418f, "v_1")
    val v_2 = new Point3D(20.673238f, 0.000000f, 107.524443f, "v_2")
    val v_3 = new Point3D(18.476512f, 2.218395f, 113.559898f, "v_3")
    val v_4 = new Point3D(20.477247f, 3.249866f, 108.062924f, "v_4")
    val v_5 = new Point3D(13.139506f, 3.301684f, 111.820659f, "v_5")
    val v_6 = new Point3D(15.140241f, 4.333154f, 106.323684f, "v_6")
    val v_7 = new Point3D(10.099361f, 7.300849f, 110.846453f, "v_7")
    val v_8 = new Point3D(11.714769f, 8.133666f, 106.408155f, "v_8")
    val v_9 = new Point3D(2.967094f, 7.300849f, 108.250520f, "v_9")
    val v_10 = new Point3D(4.582502f, 8.133666f, 103.812222f, "v_10")
    val v_11 = new Point3D(0.735563f, 3.301684f, 107.305993f, "v_11")
    val v_12 = new Point3D(2.736298f, 4.333154f, 101.809018f, "v_12")
    val v_13 = new Point3D(-2.235924f, 2.868369f, 106.143151f, "v_13")
    val v_14 = new Point3D(-0.235189f, 3.899839f, 100.646177f, "v_14")
    ...
    val actual = HiddenLineRemovalUtils.removeHiddenLines(triangles.toList, lines.toList, 0.5)

    actual.length must_== 17
  }
  ...
  "carVertex,-10, 0, 20, 0, 10, 0" in {
    ...
    actual.length must_== 21
  }

  "carVertex,0, 0, 60, 0, 10, 0" in {
    val v_1 = new Point3D(16.144191f, 0.000000f, 83.917441f, "v_1")
    val v_2 = new Point3D(11.000000f, 0.000000f, 80.947441f, "v_2")
    val v_3 = new Point3D(16.144191f, 3.300000f, 83.917441f, "v_3")
    val v_4 = new Point3D(11.000000f, 3.300000f, 80.947441f, "v_4")
    val v_5 = new Point3D(13.339191f, 4.400000f, 88.775844f, "v_5")
    val v_6 = new Point3D(8.195000f, 4.400000f, 85.805844f, "v_6")
    val v_7 = new Point3D(11.248824f, 8.360000f, 91.252465f, "v_7")
    val v_8 = new Point3D(7.095367f, 8.360000f, 88.854465f, "v_8")
    val v_9 = new Point3D(7.453824f, 8.360000f, 97.825597f, "v_9")
    val v_10 = new Point3D(3.300367f, 8.360000f, 95.427597f, "v_10")
    val v_11 = new Point3D(6.739191f, 4.400000f, 100.207379f, "v_11")
    val v_12 = new Point3D(1.595000f, 4.400000f, 97.237379f, "v_12")
    val v_13 = new Point3D(5.144191f, 3.960000f, 102.970000f, "v_13")
    val v_14 = new Point3D(0.000000f, 3.960000f, 100.000000f, "v_14")
    val v_15 = new Point3D(5.144191f, 0.000000f, 102.970000f, "v_15")
    val v_16 = new Point3D(0.000000f, 0.000000f, 100.000000f, "v_16")
  ...
  "carVertex,0, 0, -60, 0, 10, 0" in {
    val v_1 = new Point3D(5.855809f, 0.000000f, 122.022559f, "v_1")
    val v_2 = new Point3D(11.000000f, 0.000000f, 119.052559f, "v_2")
    val v_3 = new Point3D(5.855809f, 3.300000f, 122.022559f, "v_3")
    val v_4 = new Point3D(11.000000f, 3.300000f, 119.052559f, "v_4")
    val v_5 = new Point3D(3.050809f, 4.400000f, 117.164156f, "v_5")
    val v_6 = new Point3D(8.195000f, 4.400000f, 114.194156f, "v_6")
    val v_7 = new Point3D(1.951176f, 8.360000f, 114.115535f, "v_7")
    val v_8 = new Point3D(6.104633f, 8.360000f, 111.717535f, "v_8")
    val v_9 = new Point3D(-1.843824f, 8.360000f, 107.542403f, "v_9")
    val v_10 = new Point3D(2.309633f, 8.360000f, 105.144403f, "v_10")
    val v_11 = new Point3D(-3.549191f, 4.400000f, 105.732621f, "v_11")
    val v_12 = new Point3D(1.595000f, 4.400000f, 102.762621f, "v_12")
    val v_13 = new Point3D(-5.144191f, 3.960000f, 102.970000f, "v_13")
    val v_14 = new Point3D(0.000000f, 3.960000f, 100.000000f, "v_14")
    val v_15 = new Point3D(-5.144191f, 0.000000f, 102.970000f, "v_15")
    val v_16 = new Point3D(0.000000f, 0.000000f, 100.000000f, "v_16")
