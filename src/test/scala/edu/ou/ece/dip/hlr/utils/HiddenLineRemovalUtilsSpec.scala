...
//    val actual = HiddenLineRemovalUtils.removeHiddenLines(List(Triangle3D(v_11, v_12, v_14), Triangle3D(v_6, v_12, v_14)), List(v_9 to v_11), 0.5)
//    val actual = HiddenLineRemovalUtils.removeHiddenLines(triangles.toList, List(v_9 to v_11), 0.5)
//    val actual = HiddenLineRemovalUtils.removeHiddenLines(List(Triangle3D(v_11, v_12, v_14), Triangle3D(v_6, v_12, v_14)), lines.toList, 0.5)
    val actual = HiddenLineRemovalUtils.removeHiddenLines(triangles.toList, lines.toList, 0.5)

    actual.length must_== 7
  }
}